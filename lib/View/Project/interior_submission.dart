...
class InteriorSubmission extends StatelessWidget {
  ...
  InteriorSubmission({super.key, required this.report});
  ...
  final List<String> tempInteriorImage = [
    "Living Room",
    "Kitchen",
    "Bedroom",
    "Balcony",
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text("Interior Design", style: TextStyle(
                            fontSize: 1.t,
                            color: Colors.black,
                ...
                Row(
                  children: [
                    Container(
                        ...
                        child: Text("Interior Image", style: TextStyle(
                          fontSize: 1.t,
                          fontWeight: FontWeight.bold,
                          color: Colors.black,
                        ),)),
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Padding(
                            ...
                            child: SubmissionItem(submissionName: tempInteriorImage[index], onPreview: (){}, onDelete: (){}, onEdit: (){}),
                          );
                        }),
                  ),
                ),
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Padding(
                            ...
                            child: SubmissionItem(submissionName: "Front View", onPreview: (){}, onDelete: (){}, onEdit: (){}),
                          );
                        }),
                  ),
                ),
                  ...
                  child: Scrollbar(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 10.0),
                            child: SubmissionItem(submissionName: "3D AR Model ${index + 1}", onPreview: (){}, onDelete: (){}, onEdit: (){}),
                          );
                        }),
                  ),
                ),
                  ...
                  child: Scrollbar(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 10.0),
                            child: SubmissionItem(submissionName: "Front Elevation Dimensions ${index + 1}", onPreview: (){}, onDelete: (){}, onEdit: (){}),
                          );
                        }),
                  ),
                ),
                  ...
                  child: Scrollbar(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 10.0),
                            child: PaintCard(paintName: "Touch of Spring-n", paintCode: "#3226", paintImage: "https://www.asianpaints.com/content/dam/asian_paints/colours/swatches/7806.png.transform/cc-width-720-height-540/image.png", onPreview: () {  }, onEdit: () {  }, onDelete: () {  },),
                          );
                        }),
                  ),
                ),
