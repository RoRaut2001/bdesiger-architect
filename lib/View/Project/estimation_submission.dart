...
class EstimationSubmission extends StatelessWidget {
  ...
  EstimationSubmission({super.key, required this.report});
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text("Estimation", style: TextStyle(
                            fontSize: 0.9.t,
                            color: Colors.black,
                ...
                Row(
                  children: [
                    Container(
                        ...
                        child: Text("Estimation Budget", style: TextStyle(
                          fontSize: 1.t,
                          fontWeight: FontWeight.bold,
                          color: Colors.black,
                        ),)),
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Padding(
                            ...
                            child: SubmissionItem(submissionName: "Estimation Document", onPreview: (){}, onDelete: (){}, onEdit: (){}),
                          );
                        }),
                  ),
                ),
