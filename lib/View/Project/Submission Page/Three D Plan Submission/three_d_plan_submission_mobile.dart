...
class ThreeDPlanSubmissionMobile extends StatelessWidget {
  ThreeDPlanSubmissionMobile({super.key});
            ...
            child: Column(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SubmissionPageHeadingsIconsMobile(title: '3D Elevation',),
                ...
                Container(height: 2, width: 80, color: Colors.black),
                ReportCardImagePickerMobile(
                  imageUrls: controller.submission.value.arModel,
                ...
                ReportCardFilePickerMobile(
                  fileUrls: controller.submission.value.arModel,
                ...
                ReportCardImagePickerMobile(
                  ...
                  imageList: controller.elevationImage,
                  onPick: controller.pickFile,
                  onAdd: () => controller.addFileToList(controller.elevationImage, "elevation_image"),
                ),
                const SizedBox(height: 15),
                /**** Exterior Paints ****/
                ...
                ReportCardFilePickerMobile(
                  ...
                  fileList: controller.threeDDocument,
                  onPick: controller.pickFile,
                  onAdd: () => controller.addFileToList(controller.threeDDocument, "three_d_document"),
                ),
                const SizedBox(height: 15),
