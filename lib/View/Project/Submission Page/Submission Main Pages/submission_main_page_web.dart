...
class SubmissionMainPageWeb extends StatelessWidget {
  SubmissionMainPageWeb({super.key});
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          leading: Image.network(icon, width: 35, height: 35),
          trailing: const Icon(Icons.arrow_forward, color: Colors.black, size: 30),
        ),
      ),
    );
  }
