...
class SubmissionMainPageTab extends StatelessWidget {
  SubmissionMainPageTab({super.key});
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          child: const Icon(Icons.arrow_back_rounded, size: 40, color: Colors.black),
        ),
      ),
            ...
            children: [
              ...
              GridView(
                ...
                children: [
                  ...
                  if (selectedServices.isNotEmpty) // Optional condition for Estimation
                    _buildSubmissionCard(
                      title: "Estimation",
                      icon: kaFloorPlan,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          subtitle: Text(
            "Update the data",
            style: TextStyle(fontSize: 9, color: const Color(0xFF7B7B7B)),
          ),
          leading: Image.network(icon, width: 31, height: 31),
          trailing: const Icon(Icons.arrow_forward, color: Colors.black, size: 25),
        ),
      ),
    );
  }
