...
class StructureDesignSubmissionWeb extends StatelessWidget {
  StructureDesignSubmissionWeb({super.key});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    SubmissionPageHeadingsIcons(title: 'Structure Design',),
                    const Spacer(),
                ...
                ReportCardImagePicker(
                  ...
                  onAdd: () => controller.addImageToList(controller.structureDesign, "structural_design"),
                ),
