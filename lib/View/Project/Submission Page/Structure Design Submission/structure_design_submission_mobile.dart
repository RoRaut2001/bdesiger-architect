...
class StructureDesignSubmissionMobile extends StatelessWidget {
  StructureDesignSubmissionMobile({super.key});
        ...
        children: [
          ListTile(
            ...
            CircularProgressIndicator(strokeCap: StrokeCap.round,)
                : UpdateButton(onTap: (){
              controller.structuralPlanSubmission(context, report.projectId ?? "", 2);
            })),
          ),
            ...
            child: Column(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SubmissionPageHeadingsIconsMobile(title: 'Structure Design',),
                ...
                ReportCardImagePickerMobile(
                  imageUrls: controller.submission.value.structuralDesign,
                  imageList: controller.structureDesign,
                  onPick: controller.pickImage,
                  onAdd: () => controller.addImageToList(controller.structureDesign, "structure_design"),
                ),
                const SizedBox(height: 30),
                Obx(() {
                  return ListView.builder(
                    shrinkWrap: true,
                    itemCount: clientController.structuralPlanRevisionsChargesDiscounts.length,
                    itemBuilder: (_, index) {
                      final section = clientController.structuralPlanRevisionsChargesDiscounts[index];
