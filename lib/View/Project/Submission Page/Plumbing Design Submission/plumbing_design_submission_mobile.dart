...
class PlumbingDesignSubmissionMobile extends StatelessWidget {
  PlumbingDesignSubmissionMobile({super.key});
            ...
            child: Column(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SubmissionPageHeadingsIconsMobile(title: 'Plumbing Design',),
