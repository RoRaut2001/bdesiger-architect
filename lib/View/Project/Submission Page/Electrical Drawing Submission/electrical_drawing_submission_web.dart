...
class ElectricalDrawingSubmissionWeb extends StatelessWidget {
  ElectricalDrawingSubmissionWeb({super.key});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    SubmissionPageHeadingsIcons(title: 'Electrical Design',),
                    const Spacer(),
