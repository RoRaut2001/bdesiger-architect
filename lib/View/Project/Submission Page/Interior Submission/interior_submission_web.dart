...
class InteriorSubmissionWeb extends StatelessWidget {
  InteriorSubmissionWeb({super.key});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    SubmissionPageHeadingsIcons(title: 'Interior Design',),
                    Spacer(),
                ...
                ReportCardImagePicker(
                  imageUrls: controller.submission.value.interiorImage,
                  imageList: controller.interiorElevationImage,
                  onPick: controller.pickImage,
                  onAdd: () => controller.addImageToList(controller.interiorElevationImage, "interior_image"),
                ),
                ...
                ReportCardImagePicker(
                  ...
                  onPick: controller.pickImage,
                  onAdd: () => controller.addImageToList(controller.interiorElevationDimensions, "elevation_dimensions"),
                ),
                const SizedBox(height: 30),
                /**** Exterior Paints ****/
